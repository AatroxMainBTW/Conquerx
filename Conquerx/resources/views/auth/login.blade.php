                    ...
                    <div>
                        ...
                        @enderror
                            ...
                            <div class="mt-3">
                                ...
                                <label class="text-gray-900 font-bold" for="remember">
                                    {{ __('Remember Me') }}
                                </label>
                            </div>
                            ...
                            <div class="flex justify-start mt-3">
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-red-500 hover:text-red-700 hover:underline" href="{{ route('password.request') }}">
                                        {{ __('Forgot Your Password?') }}
                                    </a>
                                @endif
                        </div>

                            <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 rounded-full shadow-lg hover:shadow-xl transition duration-500 mt-5">
                                {{ __('Login') }}
                            </button>
